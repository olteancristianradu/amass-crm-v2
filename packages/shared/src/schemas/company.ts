...
export const CreateCompanySchema = z.object({
  ...
  size: CompanySizeSchema.optional().or(z.literal('').transform(() => undefined)),
  relationshipStatus: RelationshipStatusSchema.optional().or(z.literal('').transform(() => undefined)),
  leadSource: LeadSourceSchema.optional().or(z.literal('').transform(() => undefined)),
