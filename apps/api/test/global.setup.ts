/**
 * Vitest global setup — runs in the MAIN process before any workers start.
 * Sets environment variables needed when NestJS modules evaluate their
 * module-level `loadEnv()` calls during import.
 */
...
export function setup(): void {
  // Load root .env (path: test/ → api/ → apps/ → repo root)
